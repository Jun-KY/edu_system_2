...
//    RequiredArgsConstructor function -> No more constructor to declare
//    public TeacherRepository(JdbcTemplate jdbcTemplate){
//        this.jdbcTemplate = jdbcTemplate;
//    }

    private final RowMapper<Teacher> mapper = (resultSet, rowNum)-> Teacher.builder()
    ...
    public int update(Teacher teacher){
        return jdbcTemplate.update("UPDATE teacher SET name = ? WHERE id = ?",
